// Place n queens on a nXn chessboard such that each queen is safe (all arrangements)
...
bool N_Queen(int n,int i,int board[][10])
{
    ...
    if(i==n)
    {
        ...
        // to print all arrangements, we return false even though we have found a solution.
        cout<<endl;
        return false;
    }
